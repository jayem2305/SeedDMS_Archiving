	...
	{ /* {{{ */
		...
		<div class="dashboard-main-content-wrapper">
			<div class="dashboard-card-container">
				<div class="card">
					<div class="card-body">
						<input type="text" id="myInput" class="form-control mb-3" placeholder="<?= getMLText('type_to_filter'); ?>">
						<div class="table-responsive">
							<table id="myTable" class="table table-condensed table-sm table-hover thead-light">
								<thead>
									<tr>
										<th></th>
									...
									foreach ($allUsers as $currUser) {
										...
										if (count($groups) != 0) {
											for ($j = 0; $j < count($groups); $j++) {
												...
												$decrypted_name = ($maybe_decrypted === '[DECRYPTION FAILED]' || $maybe_decrypted === '[INVALID NAME]') ? $encrypted_name : $maybe_decrypted;
